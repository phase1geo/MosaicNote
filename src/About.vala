...
public class About {
  ...
  public About( MainWindow win ) {
    ...
    var image = new Image.from_resource( "/io/github/phase1geo/mosaic-note/mosaic-note-logo.svg" );

    _about = new AboutDialog() {
      authors            = { "Trevor Williams" },
      program_name       = "MosaicNote",
      comments           = _( "Note-taking application" ),
      copyright          = _( "Copyright" ) + " © 2026 Trevor Williams",
      version            = MosaicNote.current_version,
      license_type       = License.GPL_3_0,
      website            = "https://appcenter.elementary.io/io.github.phase1geo.mosaic-note/",
      website_label      = _( "MosaicNote in AppCenter" ),
